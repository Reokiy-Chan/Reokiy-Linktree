...
const links = [
  { label: 'discord', sublabel: 'join the server', href: 'https://discord.com/invite/CSxbWqjsaC', icon: 'Discord' as const, accent: '#5865F2', featured: true },
      ...
      <div className="content-wrapper">
        ...
        <div className="animate-float" style={{ position: 'relative', marginBottom: 20 }}>
          <div style={{
            ...
            borderRightColor: 'rgba(var(--pink-rgb),0.45)',
          ...
          <div style={{
            ...
            boxShadow: '0 0 32px rgba(var(--primary-rgb),0.35), 0 0 64px rgba(var(--primary-rgb),0.15)',
          }}>
            <div style={{
              ...
              {/* Discord avatar or fallback logo */}
              <img
        ...
        <div className="card" style={{ marginBottom: 16 }}>
          ...
          <div className="social-icons-row">
            {([
              ...
              return (
                <a key={icon} href={href} target="_blank" rel="noopener noreferrer" title={label}
            ...
            return (
              ...
              >
                <div style={{
                  ...
                  background: `${link.accent}20`, border: `1px solid ${link.accent}35`,
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
                  color: link.accent, flexShrink: 0, transition: 'all 0.25s ease',
                ...
                <div style={{ color: isHovered ? link.accent : 'rgba(245,232,255,0.2)', transition: 'all 0.25s ease', transform: isHovered ? 'translateX(2px)' : 'none', fontSize: 14 }}>
                  →
                </div>
              </a>
            )
        ...
        {/* ── About Me link ── */}
        <a href="/aboutme" className="aboutme-pill">
