  ...
  return (
    <main style={PAGE_SHELL}>
      ...
      <div style={{ position: 'relative', zIndex: 1, maxWidth: 420, animation: 'mt-in 0.7s ease both' }}>
        ...
        <div style={{ ...S, fontSize: 12, color: 'rgba(254,240,244,0.4)', marginTop: 14, lineHeight: 1.8 }}>
        ...
        <div style={{ ...S, fontSize: 12, color: 'rgba(254,240,244,0.22)', letterSpacing: '0.16em', textTransform: 'uppercase', marginTop: 14 }}>
          working on it{dots}
        </div>

        <div style={{ ...S, fontSize: 12, color: 'rgba(254,240,244,0.15)', letterSpacing: '0.1em', marginTop: 36 }}>
