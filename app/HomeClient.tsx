      ...
      <div className="main-layout">
        <div className="content-wrapper">
          ...
          <div style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: 10 }}>
            {LINKS.map((link, i) => {
              ...
              return (
                ...
                >
                  <div style={{ width: 38, height: 38, borderRadius: 10, background: `${link.accent}20`, border: `1px solid ${link.accent}35`, display: 'flex', alignItems: 'center', justifyContent: 'center', color: link.accent, flexShrink: 0, transition: 'background 0.25s ease, color 0.25s ease, border-color 0.25s ease, opacity 0.25s ease, transform 0.25s ease', boxShadow: isHovered ? `0 0 16px ${link.accent}40` : 'none' }}>
                    <Icon />
                  </div>
                  ...
                  <div style={{ color: isHovered ? link.accent : 'rgba(245,232,255,0.2)', transition: 'background 0.25s ease, color 0.25s ease, border-color 0.25s ease, opacity 0.25s ease, transform 0.25s ease', transform: isHovered ? 'translateX(2px)' : 'none', fontSize: 14 }}>→</div>
                </a>
              )
            })}
          </div>
          ...
          >
            ...
            <div style={{ width: 38, height: 38, borderRadius: 10, background: 'rgba(196,20,40,0.18)', border: '1px solid rgba(196,20,40,0.35)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, transition: 'background 0.25s ease, color 0.25s ease, border-color 0.25s ease, opacity 0.25s ease, transform 0.25s ease', boxShadow: raffleHovered ? '0 0 16px rgba(196,20,40,0.35)' : 'none', fontSize: 18 }}>
              🎲
            </div>
            <div style={{ flex: 1, minWidth: 0 }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 7 }}>
                ...
                {raffleCount > 0 && (
                  <span style={{ fontFamily: 'var(--font-body)', fontSize: 12, padding: '1px 6px', borderRadius: 20, background: 'rgba(34,197,94,0.15)', border: '1px solid rgba(34,197,94,0.3)', color: '#4ade80', letterSpacing: '0.08em', textTransform: 'uppercase', display: 'flex', alignItems: 'center', gap: 3 }}>
