  ...
  return (
    <main style={{
      ...
      <div style={{ position: 'relative', zIndex: 1, animation: 'nf-in 0.7s ease both' }}>
        <div className="animate-glitch" style={{
        ...
        <div style={{ ...S, fontSize: 10, color: 'rgba(254,240,244,0.35)', letterSpacing: '0.16em', textTransform: 'uppercase', marginTop: 12 }}>
          this page doesn&apos;t exist ✦
        </div>

        <Link href="/" style={{
          ...S, display: 'inline-flex', alignItems: 'center', gap: 8, marginTop: 32,
          padding: '11px 28px', borderRadius: 999,
          background: 'rgba(196,20,40,0.12)', border: '1px solid rgba(196,20,40,0.4)',
          color: 'var(--text)', fontSize: 10, letterSpacing: '0.14em', textTransform: 'uppercase',
          transition: 'all 0.25s ease', animation: 'nf-float 5s ease-in-out infinite',
        }}
